...
steps:
  ...
  angiotensin-iireceptorantagonists-aprovel---primary:
    run: angiotensin-iireceptorantagonists-aprovel---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  angiotensin-iireceptorantagonists-eprosartan---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: angiotensin-iireceptorantagonists-aprovel---primary/output
